...
default[:ruby192][:id] = "eyJzaWciOiJ5RDBXTXBNQTZ4RVRGTlo0SzBBR09tL0FkY0E9Iiwib2lkIjoi%0ANGU0ZTc4YmNhMjFlMTIxMDA0ZTRlN2Q1MTFmNTUzMDUwMTlmMzMxMGZkMjQi%0AfQ==%0A"
default[:ruby192][:path] = File.join(node[:deployment][:home], "deploy", "rubies", "ruby-#{ruby[:version]}")
